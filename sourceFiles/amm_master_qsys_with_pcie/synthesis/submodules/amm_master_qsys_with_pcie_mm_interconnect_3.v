// amm_master_qsys_with_pcie_mm_interconnect_3.v
...
`timescale 1 ps / 1 ps
module amm_master_qsys_with_pcie_mm_interconnect_3 (
	...
	wire  [147:0] rsp_mux_002_src_data;                                                      // rsp_mux_002:src_data -> sgdma_m_read_agent:rp_data
	wire          rsp_mux_002_src_ready;                                                     // sgdma_m_read_agent:rp_ready -> rsp_mux_002:src_ready
	wire    [3:0] rsp_mux_002_src_channel;                                                   // rsp_mux_002:src_channel -> sgdma_m_read_agent:rp_channel
	...
	wire  [147:0] router_002_src_data;                                                       // router_002:src_data -> cmd_demux_002:sink_data
	...
	wire          rsp_mux_src_valid;                                                         // rsp_mux:src_valid -> sgdma_descriptor_read_rsp_width_adapter:in_valid
	wire  [147:0] rsp_mux_src_data;                                                          // rsp_mux:src_data -> sgdma_descriptor_read_rsp_width_adapter:in_data
	wire          rsp_mux_src_ready;                                                         // sgdma_descriptor_read_rsp_width_adapter:in_ready -> rsp_mux:src_ready
	wire    [3:0] rsp_mux_src_channel;                                                       // rsp_mux:src_channel -> sgdma_descriptor_read_rsp_width_adapter:in_channel
	wire          rsp_mux_src_startofpacket;                                                 // rsp_mux:src_startofpacket -> sgdma_descriptor_read_rsp_width_adapter:in_startofpacket
	wire          rsp_mux_src_endofpacket;                                                   // rsp_mux:src_endofpacket -> sgdma_descriptor_read_rsp_width_adapter:in_endofpacket
	...
	wire  [111:0] sgdma_descriptor_read_rsp_width_adapter_src_data;                          // sgdma_descriptor_read_rsp_width_adapter:out_data -> sgdma_descriptor_read_agent:rp_data
	...
	wire    [3:0] sgdma_descriptor_read_rsp_width_adapter_src_channel;                       // sgdma_descriptor_read_rsp_width_adapter:out_channel -> sgdma_descriptor_read_agent:rp_channel
	...
	wire          rsp_mux_001_src_valid;                                                     // rsp_mux_001:src_valid -> sgdma_descriptor_write_rsp_width_adapter:in_valid
	wire  [147:0] rsp_mux_001_src_data;                                                      // rsp_mux_001:src_data -> sgdma_descriptor_write_rsp_width_adapter:in_data
	wire          rsp_mux_001_src_ready;                                                     // sgdma_descriptor_write_rsp_width_adapter:in_ready -> rsp_mux_001:src_ready
	wire    [3:0] rsp_mux_001_src_channel;                                                   // rsp_mux_001:src_channel -> sgdma_descriptor_write_rsp_width_adapter:in_channel
	wire          rsp_mux_001_src_startofpacket;                                             // rsp_mux_001:src_startofpacket -> sgdma_descriptor_write_rsp_width_adapter:in_startofpacket
	wire          rsp_mux_001_src_endofpacket;                                               // rsp_mux_001:src_endofpacket -> sgdma_descriptor_write_rsp_width_adapter:in_endofpacket
	...
	wire  [111:0] sgdma_descriptor_write_rsp_width_adapter_src_data;                         // sgdma_descriptor_write_rsp_width_adapter:out_data -> sgdma_descriptor_write_agent:rp_data
	...
	wire    [3:0] sgdma_descriptor_write_rsp_width_adapter_src_channel;                      // sgdma_descriptor_write_rsp_width_adapter:out_channel -> sgdma_descriptor_write_agent:rp_channel
	...
	wire          router_src_valid;                                                          // router:src_valid -> sgdma_descriptor_read_cmd_width_adapter:in_valid
	wire  [111:0] router_src_data;                                                           // router:src_data -> sgdma_descriptor_read_cmd_width_adapter:in_data
	wire          router_src_ready;                                                          // sgdma_descriptor_read_cmd_width_adapter:in_ready -> router:src_ready
	wire    [3:0] router_src_channel;                                                        // router:src_channel -> sgdma_descriptor_read_cmd_width_adapter:in_channel
	wire          router_src_startofpacket;                                                  // router:src_startofpacket -> sgdma_descriptor_read_cmd_width_adapter:in_startofpacket
	wire          router_src_endofpacket;                                                    // router:src_endofpacket -> sgdma_descriptor_read_cmd_width_adapter:in_endofpacket
	wire          sgdma_descriptor_read_cmd_width_adapter_src_valid;                         // sgdma_descriptor_read_cmd_width_adapter:out_valid -> cmd_demux:sink_valid
	wire  [147:0] sgdma_descriptor_read_cmd_width_adapter_src_data;                          // sgdma_descriptor_read_cmd_width_adapter:out_data -> cmd_demux:sink_data
	wire          sgdma_descriptor_read_cmd_width_adapter_src_ready;                         // cmd_demux:sink_ready -> sgdma_descriptor_read_cmd_width_adapter:out_ready
	wire    [3:0] sgdma_descriptor_read_cmd_width_adapter_src_channel;                       // sgdma_descriptor_read_cmd_width_adapter:out_channel -> cmd_demux:sink_channel
	wire          sgdma_descriptor_read_cmd_width_adapter_src_startofpacket;                 // sgdma_descriptor_read_cmd_width_adapter:out_startofpacket -> cmd_demux:sink_startofpacket
	wire          sgdma_descriptor_read_cmd_width_adapter_src_endofpacket;                   // sgdma_descriptor_read_cmd_width_adapter:out_endofpacket -> cmd_demux:sink_endofpacket
	wire          router_001_src_valid;                                                      // router_001:src_valid -> sgdma_descriptor_write_cmd_width_adapter:in_valid
	wire  [111:0] router_001_src_data;                                                       // router_001:src_data -> sgdma_descriptor_write_cmd_width_adapter:in_data
	wire          router_001_src_ready;                                                      // sgdma_descriptor_write_cmd_width_adapter:in_ready -> router_001:src_ready
	wire    [3:0] router_001_src_channel;                                                    // router_001:src_channel -> sgdma_descriptor_write_cmd_width_adapter:in_channel
	wire          router_001_src_startofpacket;                                              // router_001:src_startofpacket -> sgdma_descriptor_write_cmd_width_adapter:in_startofpacket
	wire          router_001_src_endofpacket;                                                // router_001:src_endofpacket -> sgdma_descriptor_write_cmd_width_adapter:in_endofpacket
	wire          sgdma_descriptor_write_cmd_width_adapter_src_valid;                        // sgdma_descriptor_write_cmd_width_adapter:out_valid -> cmd_demux_001:sink_valid
	wire  [147:0] sgdma_descriptor_write_cmd_width_adapter_src_data;                         // sgdma_descriptor_write_cmd_width_adapter:out_data -> cmd_demux_001:sink_data
	wire          sgdma_descriptor_write_cmd_width_adapter_src_ready;                        // cmd_demux_001:sink_ready -> sgdma_descriptor_write_cmd_width_adapter:out_ready
	wire    [3:0] sgdma_descriptor_write_cmd_width_adapter_src_channel;                      // sgdma_descriptor_write_cmd_width_adapter:out_channel -> cmd_demux_001:sink_channel
	wire          sgdma_descriptor_write_cmd_width_adapter_src_startofpacket;                // sgdma_descriptor_write_cmd_width_adapter:out_startofpacket -> cmd_demux_001:sink_startofpacket
	wire          sgdma_descriptor_write_cmd_width_adapter_src_endofpacket;                  // sgdma_descriptor_write_cmd_width_adapter:out_endofpacket -> cmd_demux_001:sink_endofpacket
	wire          pcie_ip_txs_agent_rdata_fifo_src_valid;                                    // pcie_ip_txs_agent:rdata_fifo_src_valid -> avalon_st_adapter:in_0_valid
	wire   [65:0] pcie_ip_txs_agent_rdata_fifo_src_data;                                     // pcie_ip_txs_agent:rdata_fifo_src_data -> avalon_st_adapter:in_0_data
	wire          pcie_ip_txs_agent_rdata_fifo_src_ready;                                    // avalon_st_adapter:in_0_ready -> pcie_ip_txs_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_out_0_valid;                                             // avalon_st_adapter:out_0_valid -> pcie_ip_txs_agent:rdata_fifo_sink_valid
	wire   [65:0] avalon_st_adapter_out_0_data;                                              // avalon_st_adapter:out_0_data -> pcie_ip_txs_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_out_0_ready;                                             // pcie_ip_txs_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire    [0:0] avalon_st_adapter_out_0_error;                                             // avalon_st_adapter:out_0_error -> pcie_ip_txs_agent:rdata_fifo_sink_error
	...
	amm_master_qsys_with_pcie_mm_interconnect_3_router router (
	...
	amm_master_qsys_with_pcie_mm_interconnect_3_router router_001 (
	...
	amm_master_qsys_with_pcie_mm_interconnect_3_router_002 router_002 (
	...
	amm_master_qsys_with_pcie_mm_interconnect_3_router_002 router_003 (
	...
	amm_master_qsys_with_pcie_mm_interconnect_3_router_004 router_004 (
	...
	amm_master_qsys_with_pcie_mm_interconnect_3_cmd_demux cmd_demux (
		.clk                (pcie_ip_pcie_core_clk_clk),                                 //       clk.clk
		.reset              (sgdma_reset_reset_bridge_in_reset_reset),                   // clk_reset.reset
	...
	amm_master_qsys_with_pcie_mm_interconnect_3_cmd_demux cmd_demux_001 (
		.clk                (pcie_ip_pcie_core_clk_clk),                                  //       clk.clk
		.reset              (sgdma_reset_reset_bridge_in_reset_reset),                    // clk_reset.reset
	...
	amm_master_qsys_with_pcie_mm_interconnect_3_cmd_demux cmd_demux_002 (
		.clk                (pcie_ip_pcie_core_clk_clk),               //       clk.clk
		.reset              (sgdma_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	amm_master_qsys_with_pcie_mm_interconnect_3_cmd_demux cmd_demux_003 (
		.clk                (pcie_ip_pcie_core_clk_clk),               //       clk.clk
		.reset              (sgdma_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	amm_master_qsys_with_pcie_mm_interconnect_3_cmd_mux cmd_mux (
		.clk                 (pcie_ip_pcie_core_clk_clk),                                //       clk.clk
		.reset               (pcie_ip_txs_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	amm_master_qsys_with_pcie_mm_interconnect_3_rsp_demux rsp_demux (
		.clk                (pcie_ip_pcie_core_clk_clk),                                //       clk.clk
		.reset              (pcie_ip_txs_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	amm_master_qsys_with_pcie_mm_interconnect_3_rsp_mux rsp_mux (
		.clk                 (pcie_ip_pcie_core_clk_clk),               //       clk.clk
		.reset               (sgdma_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	amm_master_qsys_with_pcie_mm_interconnect_3_rsp_mux rsp_mux_001 (
		.clk                 (pcie_ip_pcie_core_clk_clk),               //       clk.clk
		.reset               (sgdma_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	amm_master_qsys_with_pcie_mm_interconnect_3_rsp_mux rsp_mux_002 (
		.clk                 (pcie_ip_pcie_core_clk_clk),               //       clk.clk
		.reset               (sgdma_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	amm_master_qsys_with_pcie_mm_interconnect_3_rsp_mux rsp_mux_003 (
		.clk                 (pcie_ip_pcie_core_clk_clk),               //       clk.clk
		.reset               (sgdma_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	amm_master_qsys_with_pcie_mm_interconnect_3_avalon_st_adapter #(
		.inBitsPerSymbol (66),
		.inUsePackets    (0),
		.inDataWidth     (66),
		.inChannelWidth  (0),
