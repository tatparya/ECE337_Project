...
module amm_master_qsys_with_pcie_mm_interconnect_0 (
	...
	wire  [101:0] rsp_mux_src_data;                                                                                    // rsp_mux:src_data -> custom_module_avalon_master_agent:rp_data
	wire          rsp_mux_src_ready;                                                                                   // custom_module_avalon_master_agent:rp_ready -> rsp_mux:src_ready
	wire    [1:0] rsp_mux_src_channel;                                                                                 // rsp_mux:src_channel -> custom_module_avalon_master_agent:rp_channel
	...
	wire  [101:0] cmd_mux_src_data;                                                                                    // cmd_mux:src_data -> sdram_s1_agent:cp_data
	...
	wire  [102:0] altpll_qsys_pll_slave_agent_rf_source_data;                                                          // altpll_qsys_pll_slave_agent:rf_source_data -> altpll_qsys_pll_slave_agent_rsp_fifo:in_data
	...
	wire  [102:0] altpll_qsys_pll_slave_agent_rsp_fifo_out_data;                                                       // altpll_qsys_pll_slave_agent_rsp_fifo:out_data -> altpll_qsys_pll_slave_agent:rf_sink_data
	...
	wire  [101:0] cmd_mux_001_src_data;                                                                                // cmd_mux_001:src_data -> altpll_qsys_pll_slave_agent:cp_data
	wire          cmd_mux_001_src_ready;                                                                               // altpll_qsys_pll_slave_agent:cp_ready -> cmd_mux_001:src_ready
	wire    [1:0] cmd_mux_001_src_channel;                                                                             // cmd_mux_001:src_channel -> altpll_qsys_pll_slave_agent:cp_channel
	...
	wire  [101:0] custom_module_avalon_master_agent_cp_data;                                                           // custom_module_avalon_master_agent:cp_data -> router:sink_data
	...
	wire  [101:0] video_pixel_buffer_dma_0_avalon_pixel_dma_master_agent_cp_data;                                      // video_pixel_buffer_dma_0_avalon_pixel_dma_master_agent:cp_data -> router_001:sink_data
	...
	wire  [101:0] sdram_s1_agent_rp_data;                                                                              // sdram_s1_agent:rp_data -> router_002:sink_data
	...
	wire          altpll_qsys_pll_slave_agent_rp_valid;                                                                // altpll_qsys_pll_slave_agent:rp_valid -> router_003:sink_valid
	wire  [101:0] altpll_qsys_pll_slave_agent_rp_data;                                                                 // altpll_qsys_pll_slave_agent:rp_data -> router_003:sink_data
	wire          altpll_qsys_pll_slave_agent_rp_ready;                                                                // router_003:sink_ready -> altpll_qsys_pll_slave_agent:rp_ready
	wire          altpll_qsys_pll_slave_agent_rp_startofpacket;                                                        // altpll_qsys_pll_slave_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          altpll_qsys_pll_slave_agent_rp_endofpacket;                                                          // altpll_qsys_pll_slave_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire  [101:0] router_001_src_data;                                                                                 // router_001:src_data -> video_pixel_buffer_dma_0_avalon_pixel_dma_master_limiter:cmd_sink_data
	wire          router_001_src_ready;                                                                                // video_pixel_buffer_dma_0_avalon_pixel_dma_master_limiter:cmd_sink_ready -> router_001:src_ready
	wire    [1:0] router_001_src_channel;                                                                              // router_001:src_channel -> video_pixel_buffer_dma_0_avalon_pixel_dma_master_limiter:cmd_sink_channel
	...
	wire  [101:0] video_pixel_buffer_dma_0_avalon_pixel_dma_master_limiter_cmd_src_data;                               // video_pixel_buffer_dma_0_avalon_pixel_dma_master_limiter:cmd_src_data -> cmd_demux_001:sink_data
	...
	wire    [1:0] video_pixel_buffer_dma_0_avalon_pixel_dma_master_limiter_cmd_src_channel;                            // video_pixel_buffer_dma_0_avalon_pixel_dma_master_limiter:cmd_src_channel -> cmd_demux_001:sink_channel
	...
	wire  [101:0] rsp_mux_001_src_data;                                                                                // rsp_mux_001:src_data -> video_pixel_buffer_dma_0_avalon_pixel_dma_master_limiter:rsp_sink_data
	wire          rsp_mux_001_src_ready;                                                                               // video_pixel_buffer_dma_0_avalon_pixel_dma_master_limiter:rsp_sink_ready -> rsp_mux_001:src_ready
	wire    [1:0] rsp_mux_001_src_channel;                                                                             // rsp_mux_001:src_channel -> video_pixel_buffer_dma_0_avalon_pixel_dma_master_limiter:rsp_sink_channel
	...
	wire  [101:0] video_pixel_buffer_dma_0_avalon_pixel_dma_master_limiter_rsp_src_data;                               // video_pixel_buffer_dma_0_avalon_pixel_dma_master_limiter:rsp_src_data -> video_pixel_buffer_dma_0_avalon_pixel_dma_master_agent:rp_data
	...
	wire    [1:0] video_pixel_buffer_dma_0_avalon_pixel_dma_master_limiter_rsp_src_channel;                            // video_pixel_buffer_dma_0_avalon_pixel_dma_master_limiter:rsp_src_channel -> video_pixel_buffer_dma_0_avalon_pixel_dma_master_agent:rp_channel
	...
	wire    [1:0] video_pixel_buffer_dma_0_avalon_pixel_dma_master_limiter_cmd_valid_data;                             // video_pixel_buffer_dma_0_avalon_pixel_dma_master_limiter:cmd_src_valid -> cmd_demux_001:sink_valid
	...
	wire          altpll_qsys_pll_slave_agent_rdata_fifo_out_valid;                                                    // altpll_qsys_pll_slave_agent_rdata_fifo:out_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] altpll_qsys_pll_slave_agent_rdata_fifo_out_data;                                                     // altpll_qsys_pll_slave_agent_rdata_fifo:out_data -> avalon_st_adapter_001:in_0_data
	wire          altpll_qsys_pll_slave_agent_rdata_fifo_out_ready;                                                    // avalon_st_adapter_001:in_0_ready -> altpll_qsys_pll_slave_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_001_out_0_valid;                                                                   // avalon_st_adapter_001:out_0_valid -> altpll_qsys_pll_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_001_out_0_data;                                                                    // avalon_st_adapter_001:out_0_data -> altpll_qsys_pll_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_001_out_0_ready;                                                                   // altpll_qsys_pll_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire    [0:0] avalon_st_adapter_001_out_0_error;                                                                   // avalon_st_adapter_001:out_0_error -> altpll_qsys_pll_slave_agent:rdata_fifo_sink_error
